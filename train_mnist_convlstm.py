...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/mnist_convlstm',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/mnist_convlstm',
                           'dir to store result.')
# model
tf.app.flags.DEFINE_string('model_name', 'convlstm',
...
tf.app.flags.DEFINE_string('num_hidden', '128,128,128,128',   ### predrnn: a 4-layer architecture with 128 hiddenstates in each layer  predrnn-pp: 128,64,64,64
