...
# data I/O
tf.app.flags.DEFINE_string('dataset_name', 'action',
                           'The name of dataset.')
...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/kth_stdlstm',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/kth_stdlstm',
                           'dir to store result.')
# model
...
tf.app.flags.DEFINE_string('num_hidden', '128,128,128,128',
...
tf.app.flags.DEFINE_float('lr', 0.001,
                          'base learning rate.')
tf.app.flags.DEFINE_boolean('reverse_input', True,  ### change 1.20
...
tf.app.flags.DEFINE_integer('max_iterations', 80000,
                            'max num of steps.')
# tf.app.flags.DEFINE_integer('max_iterations', 20,
#                            'max num of steps.')
