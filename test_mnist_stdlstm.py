...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/mnist_stdlstm_test',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/mnist_stdlstm_test',
                           'dir to store result.')
# model
tf.app.flags.DEFINE_string('model_name', 'stdlstm',
                           'The name of the architecture.')
tf.app.flags.DEFINE_string('pretrained_model', '', ### the saved model
                           'file of a pretrained model to initialize from.')
tf.app.flags.DEFINE_integer('input_length', 10,
                            'encoder hidden states.')
tf.app.flags.DEFINE_integer('seq_length', 20,  # 20 for train
