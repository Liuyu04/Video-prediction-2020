...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/mnist_predrnn',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/mnist_predrnn',
                           'dir to store result.')
# model
tf.app.flags.DEFINE_string('model_name', 'predrnn',
