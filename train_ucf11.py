...
# data I/O
tf.app.flags.DEFINE_string('dataset_name', 'ucf101_own1',
                           'The name of dataset.')
...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints_ucf101/ucf101_stdlstm_v2',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results_ucf101/ucf101_stdlstm_v2',
                           'dir to store result.')
# model
tf.app.flags.DEFINE_string('model_name', 'stdlstm',
                           'The name of the architecture.')
tf.app.flags.DEFINE_string('pretrained_model', 'checkpoints_ucf101/ucf101_stdlstm_v1/model.ckpt-5000',
                           'file of a pretrained model to initialize from.')
tf.app.flags.DEFINE_integer('input_length', 16,
                            'encoder hidden states.')
tf.app.flags.DEFINE_integer('seq_length', 17,  # 20 for train
