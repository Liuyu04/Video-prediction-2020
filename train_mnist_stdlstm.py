...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/mnist_stdlstm',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/mnist_stdlstm',
                           'dir to store result.')
# model
...
tf.app.flags.DEFINE_integer('max_iterations', 80000,  # 80000
                            'max num of steps.')
# tf.app.flags.DEFINE_integer('max_iterations', 1,
#                            'max num of steps.')
