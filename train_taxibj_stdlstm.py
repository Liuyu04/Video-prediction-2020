...
# data I/O
tf.app.flags.DEFINE_string('dataset_name', 'taxibj',
                           'The name of dataset.')
...
tf.app.flags.DEFINE_string('save_dir', 'checkpoints/taxibj_stdlstm',
                           'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', 'results/taxibj_stdlstm',
                           'dir to store result.')
# model
...
tf.app.flags.DEFINE_integer('input_length', 4,
                            'encoder hidden states.')
tf.app.flags.DEFINE_integer('seq_length', 8,  # 20 for train
        ...
        def test(model, test_input_handle, configs, save_name):
            ...
            while not test_input_handle.no_batch_left():
                ...
                if len(img_gen.shape) > 3:
                    ...
                    # print("img_gen_shape", img_gen.shape)
